...
USBGlobals::USBGlobals ( void )
{
	...
	{ static int once = 0; if (!once++) sysctl_register_oid ( &sysctl__debug_USB ); } /* ravynOS: kext static ctors can run twice */
...
USBGlobals::~USBGlobals ( void )
{
	...
	{ static int once = 0; if (!once++) sysctl_unregister_oid ( &sysctl__debug_USB ); }
